document.addEventListener('DOMContentLoaded', function () {
  ...
  const successToast = successToastEl ? new bootstrap.Toast(successToastEl, { autohide: true, delay: 4000 }) : null;
  const errorToast = errorToastEl ? new bootstrap.Toast(errorToastEl, { autohide: true, delay: 5000 }) : null;
